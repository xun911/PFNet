...
#    feature_extraction_winstride = constant.FEATURE_EXTRACTION_WIN_STRIDE   
    ...
    semg_root = '/data/datasets/ninapro-db5' 
#    semg_root = None


    feature_root = ('/data/ninapro-feature/ninapro-db5-var-raw-flip-prepro-lowpass-win-%d-stride-%d/' % (feature_extraction_winlength, 
