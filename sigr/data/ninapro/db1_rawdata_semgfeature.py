...
#    feature_extraction_winstride = constant.FEATURE_EXTRACTION_WIN_STRIDE   
 ...
 #   semg_root = '/home/weiwentao/public-2/data/ninapro-db1/data' 
    semg_root = '/data/datasets/ninapro-db1/data' 
...
#        fea_dims = feature.shape[1]
#        semg_dims = feature.shape[2]
#       
#        feature = feature.reshape(feature.shape[0], fea_dims*semg_dims)
#        stats.zscore(feature, axis=0)
#        where_are_nan = np.isnan(feature)  
#        feature[where_are_nan] = 0 
#        feature = feature.reshape(feature.shape[0], fea_dims, semg_dims)
