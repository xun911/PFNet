...
#        net = mx.symbol.Reshape(net, shape=(0, -1, test_shape[2], 1))
        ...
        test_shape = self.infer_shape(net)
        print 'data stream shape after conv:', test_shape
...
#                print 'Concatenated Feature Shape:', self.infer_shape(feature_4)
                ...
                print 'SUBNET1 Concatenated flattened Feature Shape:', self.infer_shape(subnet1)
                ...
                subnet2 = mx.symbol.Concat(*[feature_1, feature_2], dim=1) 
                print 'SUBNET2 Concatenated FC Feature Shape:', self.infer_shape(subnet2)
                
                
                name='subnet2_fusion_bottleneck'                 
                ...
                print self.infer_shape(subnet2)
...
#                feature_2 = self.get_bn_relu(name, feature_2)  
# 
#                subnet3 = mx.symbol.Concat(*[feature_1, feature_2], dim=1) 
#                print 'SUBNET3 Concatenated FC Feature Shape:', self.infer_shape(subnet3)
#                
#                name='subnet3_fusion_bottleneck'                 
...
#                
#                name = 'subnet3_gesture'  
#                subnet3 = mx.symbol.FullyConnected(
#                    name=name + '_last_fc',
#                    data=subnet3,
#                    num_hidden=num_gesture,
#                    no_bias=False,
#                    attr=dict(**fc_attr)
#                )   
#                subnet3 = mx.symbol.SoftmaxOutput(name=name + '_softmaxactive', data=subnet3, label=gesture_label)    
#                print self.infer_shape(subnet3)
